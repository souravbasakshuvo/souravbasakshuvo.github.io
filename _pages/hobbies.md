...
<div id="bd-map-container" style="position:relative;margin-bottom:10px;max-width:90%;margin-left:auto;margin-right:auto;">
  ...
  <div style="position:absolute;top:10px;right:10px;background:var(--global-card-bg-color);border:1px solid var(--global-divider-color);border-radius:8px;padding:6px 10px;font-size:0.88em;line-height:1.8;z-index:10;color:var(--global-text-color);">
    ...
    <span style="display:inline-block;width:12px;height:12px;border-radius:3px;background:#f5efe6;border:1px solid #ccc;margin-right:5px;vertical-align:middle;"></span>Yet to be visited
...
<div id="india-map-container" style="position:relative;margin-bottom:10px;max-width:90%;margin-left:auto;margin-right:auto;">
...
<div id="india-panel" style="display:none;border:1px solid var(--global-divider-color);background:var(--global-card-bg-color);border-radius:10px;padding:14px 16px;margin-top:10px;">
  <div id="ip-name" style="font-size:1.2em;font-weight:bold;margin-bottom:4px;"></div>
  <div id="ip-cities" style="font-size:0.88em;color:var(--global-text-color);margin-bottom:8px;"></div>
  <div id="ip-spots"></div>
</div>
...
<div style="margin-bottom:10px;">
  ...
  <div id="africa-map-container" style="position:relative;margin-bottom:10px;max-width:90%;margin-left:auto;margin-right:auto;">
...
<div style="margin-bottom:10px;">
  ...
  <div id="asia-map-container" style="position:relative;margin-bottom:10px;max-width:90%;margin-left:auto;margin-right:auto;">
...
<div style="margin-bottom:10px;">
  ...
  <div id="namerica-map-container" style="position:relative;margin-bottom:10px;max-width:90%;margin-left:auto;margin-right:auto;">
...
<div style="margin-bottom:10px;">
  ...
  <div id="samerica-map-container" style="position:relative;margin-bottom:10px;max-width:90%;margin-left:auto;margin-right:auto;">
...
<div style="margin-bottom:10px;">
  ...
  <div id="europe-map-container" style="position:relative;margin-bottom:10px;max-width:90%;margin-left:auto;margin-right:auto;">
...
<div style="margin-bottom:10px;">
  ...
  <div id="oceania-map-container" style="position:relative;margin-bottom:10px;max-width:90%;margin-left:auto;margin-right:auto;">
...
<div style="border:1px solid var(--global-divider-color);background:var(--global-card-bg-color);border-radius:10px;padding:18px 22px;margin-bottom:14px;">
  <div style="font-size:1.1em;font-weight:bold;margin-bottom:6px;">🐠 Fishkeeping &amp; Aquascaping</div>
  <div style="font-size:0.95em;color:var(--global-text-color);">I maintain freshwater aquariums and enjoy the art of aquascaping — arranging aquatic plants, rocks, and driftwood to create miniature underwater landscapes. It is a relaxing and creative pursuit.</div>
</div>

<div style="border:1px solid var(--global-divider-color);background:var(--global-card-bg-color);border-radius:10px;padding:18px 22px;margin-bottom:14px;">
  <div style="font-size:1.1em;font-weight:bold;margin-bottom:6px;">🐦 Bird Keeping</div>
  <div style="font-size:0.95em;color:var(--global-text-color);">I enjoy keeping and raising birds, observing their behaviours and personalities. It is a rewarding hobby that brings life and energy to my living space.</div>
</div>

<div style="border:1px solid var(--global-divider-color);background:var(--global-card-bg-color);border-radius:10px;padding:18px 22px;margin-bottom:14px;">
  <div style="font-size:1.1em;font-weight:bold;margin-bottom:6px;">♟️ Chess</div>
  <div style="font-size:0.95em;color:var(--global-text-color);">Chess sharpens strategic thinking and patience. I have competed in university-level chess competitions, winning the BME Indoor Chess Championship in 2022.</div>
</div>

<div style="border:1px solid var(--global-divider-color);background:var(--global-card-bg-color);border-radius:10px;padding:18px 22px;margin-bottom:14px;">
  <div style="font-size:1.1em;font-weight:bold;margin-bottom:6px;">🏸 Badminton</div>
  <div style="font-size:0.95em;color:var(--global-text-color);">Badminton is my go-to sport for staying active and refreshed.</div>
</div>

<div style="border:1px solid var(--global-divider-color);background:var(--global-card-bg-color);border-radius:10px;padding:18px 22px;margin-bottom:14px;">
  <div style="font-size:1.1em;font-weight:bold;margin-bottom:6px;">🪙 Coin &amp; Currency Collecting</div>
  <div style="font-size:0.95em;color:var(--global-text-color);">I collect coins and banknotes from different countries and eras, each carrying a unique story of history, culture, and artistry. It complements my love for travel and world cultures.</div>
</div>
...
(function () {
  ...
  d3.json('/assets/geojson/bd-districts.json')
    ...
    var paths = bdSvg.selectAll('path')
      ...
      .attr('d', path)
      .attr('fill', function (d) { return bdSpots[getBdName(d.properties)] ? '#1b6ca8' : '#f5efe6'; })
      ...
      .on('click', function (event, d) {
        ...
        if (bdSelected) {
          ...
          d3.select(bdSelected).attr('fill', bdSpots[prevName] ? '#1b6ca8' : '#f5efe6').attr('stroke', '#ffffff').attr('stroke-width', 0.8);
        }
        bdSelected = this;
      ...
      .on('dblclick', function(event, d) {
        ...
        if (bdSelected === this) {
          var name = getBdName(d.properties);
          d3.select(this).attr('fill', bdSpots[name] ? '#1b6ca8' : '#f5efe6');
          bdSelected = null;
    ...
    bdSvg.on('dblclick', function() {
      if (bdSelected) {
        var prevName = getBdName(d3.select(bdSelected).datum().properties);
        d3.select(bdSelected).attr('fill', bdSpots[prevName] ? '#1b6ca8' : '#f5efe6');
        bdSelected = null;
        document.getElementById('district-panel').style.display = 'none';
      }
    });
    ...
    d3.json('/assets/geojson/india-states.json')
      ...
      var paths = svg.selectAll('path')
        ...
        .attr('fill', function (d) {
          ...
          return indiaSpots[name] ? '#1b6ca8' : '#f5efe6';
        })
        .attr('stroke', '#ffffff').attr('stroke-width', 0.8)
        .style('cursor', 'pointer')
        .on('mouseover', function () { d3.select(this).style('opacity', 0.8); })
        ...
        .on('click', function (event, d) {
          ...
          if (sel) {
            ...
            d3.select(sel).attr('fill', indiaSpots[prevName] ? '#1b6ca8' : '#f5efe6').attr('stroke', '#ffffff').attr('stroke-width', 0.8);
          }
          sel = this;
          d3.select(this).attr('fill', '#0d3d6b').attr('stroke', '#ffffff').attr('stroke-width', 0.8);
          showIndiaPanel(name);
        ...
        .on('dblclick', function(event, d) {
          ...
          if (sel === this) {
            var name = d.properties.st_nm || d.properties.NAME_1 || d.properties.name || d.properties.STATE || '';
            d3.select(this).attr('fill', indiaSpots[name] ? '#1b6ca8' : '#f5efe6');
            sel = null;
      ...
      svg.on('dblclick', function() {
        if (sel) {
          var prevProps = d3.select(sel).datum().properties;
          var prevName = prevProps.st_nm || prevProps.NAME_1 || prevProps.name || prevProps.STATE || '';
          d3.select(sel).attr('fill', indiaSpots[prevName] ? '#1b6ca8' : '#f5efe6');
          sel = null;
          document.getElementById('india-panel').style.display = 'none';
        }
      });
  ...
  function initSAmericaMap() { samericaMapInited = true; renderSimpleMap('samerica', '/assets/geojson/south_america.geo.json', 0.56, 'naturalearth', 0.5, false, '#1b6ca8', '#f5efe6', '#0d3d6b'); }
  function initEuropeMap()   { europeMapInited = true;   renderSimpleMap('europe',   '/assets/geojson/europe.geo.json',        0.56, 'naturalearth', 0.5, false, '#1b6ca8', '#f5efe6', '#0d3d6b'); }
  function initOceaniaMap() {
    oceaniaMapInited = true;
    renderSimpleMap('oceania', '/assets/geojson/oceania.geo.json', 0.56, 'mercator', 0.5, false, '#1b6ca8', '#f5efe6', '#0d3d6b', function(W, H) {
